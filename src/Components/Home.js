...
<h1>Home</h1>
<h2>Privacy Pilicy</h2>
<h3>Contact Us</h3>
</div>
<div className="fb"><img src={fb} alt="fb"/>
</div>
<div className="tw"><img src={tw} alt="TW1"/>
</div>
<div className="google"><img src={google} alt="GM1"/>
</div>
<div className="ll"><img src={ll} alt="ll1"/>
</div>
